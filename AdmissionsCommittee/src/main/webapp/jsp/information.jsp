	...
	<div class="container">
		...
		<div style="position:absolute; top:10%; left:15%;">
			...
			<div class="w3-container">
					...
					<div>
						<form:form method="POST"
							...
							<table>
								...
								<tr>
									<td><form:label path="evaluationOfCertificate"><spring:message code='rating.certificate' /></form:label></td>
								...
								<tr>
									<td><input type="submit" value="<spring:message code='inform.submit' />" /></td>
								</tr>
							</table>
				...
				<c:if test="${val1 != null}">
					<h5><spring:message code='rating.certificate' />: ${val1}</h5>
				</c:if>
				<!-- --------------------------------------------------------------------------------- -->
				<div>
					<!-- --------------------------------------------------------------------------------- -->
					...
					<c:if test="${val2 == null}">
						<form:form method="POST" action="${contextPath}/addEvaluations"
							...
							<table>
								...
								<tr>
									<td><form:label path="evaluation"><spring:message code='inform.math' /></form:label></td>
					...
					<c:if test="${val2 != null}">
						<h5><spring:message code='inform.math' />: ${val2}</h5>
					</c:if>
					...
					<c:if test="${val3 == null}">
						<form:form method="POST" action="${contextPath}/addEvaluations"
							...
							<table>
								...
								<tr>
									<td><form:label path="evaluation"><spring:message code='inform.language' /></form:label></td>
									<td><form:input path="evaluation" />
								</tr>
					...
					<c:if test="${val3 != null}">
						<h5><spring:message code='inform.language' />: ${val3}</h5>
					</c:if>
					...
					<c:if test="${val4 == null}">
						<form:form method="POST" action="${contextPath}/addEvaluations"
							...
							<table>
								...
								<tr>
									<td><form:label path="evaluation"><spring:message code='inform.history' /></form:label></td>
									<td><form:input path="evaluation" />
								</tr>
					...
					<c:if test="${val4 != null}">
						<h5><spring:message code='inform.history' />: ${val4}</h5>
					</c:if>
				...
				<c:if test="${val5 != null}">
					<div>
						...
						<h5><spring:message code='inform.image_added' /></h5>
						...
						<form:form method="POST" action="${contextPath}/addImage"
							...
							<table>
								...
								<tr>
									<td><input type="submit" value="<spring:message code='inform.update' />" /></td>
								</tr>
							</table>
							<input type="hidden" name="${_csrf.parameterName}"
								value="${_csrf.token}" />
