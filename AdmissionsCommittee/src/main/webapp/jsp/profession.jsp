				...
				<div>
					<form:form method="POST" action="${contextPath}/addProf"
						...
						<table>
							...
							<tr>
								<td><form:label path="faculty"><spring:message code='faculty.name' /></form:label></td>
							...
							<tr>
								<td><form:label path="name"><spring:message code='profession.name' /></form:label></td>
								<td><form:input path="name" /></td>
							</tr>
							<tr>
								<td><form:label path="planOfStudent"><spring:message code='profession.planOfStudent' /></form:label></td>
